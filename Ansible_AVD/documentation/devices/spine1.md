...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_leaf1_Ethernet3 | - | 192.168.103.0/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_leaf2_Ethernet3 | - | 192.168.103.8/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_leaf3_Ethernet3 | - | 192.168.103.16/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_leaf4_Ethernet3 | - | 192.168.103.24/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.11/32 |
...
| 192.168.103.25 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 192.168.103.9 description leaf2_Ethernet3
   neighbor 192.168.103.17 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.17 remote-as 65102
   neighbor 192.168.103.17 description leaf3_Ethernet3
   neighbor 192.168.103.25 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.25 remote-as 65102
   neighbor 192.168.103.25 description leaf4_Ethernet3
