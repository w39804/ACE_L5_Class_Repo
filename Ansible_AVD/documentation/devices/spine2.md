...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_leaf1_Ethernet4 | - | 192.168.103.2/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_leaf2_Ethernet4 | - | 192.168.103.10/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_leaf3_Ethernet4 | - | 192.168.103.18/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_leaf4_Ethernet4 | - | 192.168.103.26/31 | default | 1500 | False | - | - |
...
| 192.168.103.27 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 192.168.103.11 description leaf2_Ethernet4
   neighbor 192.168.103.19 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.19 remote-as 65102
   neighbor 192.168.103.19 description leaf3_Ethernet4
   neighbor 192.168.103.27 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.27 remote-as 65102
   neighbor 192.168.103.27 description leaf4_Ethernet4
