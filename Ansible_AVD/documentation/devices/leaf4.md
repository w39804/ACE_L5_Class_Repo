...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.24/24 | 192.168.0.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf3_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf3_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet7 | SERVER_host3_Ethernet2 | *access | *20 | *- | *- | 7 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet6 | - | 192.168.103.25/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet6 | - | 192.168.103.27/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet6 | - | 192.168.103.29/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_spine4_Ethernet6 | - | 192.168.103.31/31 | default | 1500 | False | - | - |
| Ethernet9 | - | - | 10.1.5.1/24 | VRF_A | - | False | - | - |
...
!
interface Ethernet5
   description P2P_spine3_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_spine4_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description SERVER_host3_Ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf3_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
| Port-Channel7 | PortChannel host3 | access | 20 | - | - | - | - | 7 | - |
...
interface Port-Channel1
   description MLAG_leaf3_Port-Channel1
   no shutdown
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.102.3/32 |
...
router bgp 65102
   ...
   neighbor 10.255.251.4 description leaf3_Vlan4093
   ...
   vrf VRF_A
      ...
      neighbor 10.255.251.4 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.4 description leaf3_Vlan3009
